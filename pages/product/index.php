...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['tambah'])) {
    ...
    $query = "INSERT INTO products (nama_produk, harga_produk, created_at, updated_at, jumlah, kode_unik) VALUES ('$nama_produk', $harga_produk, NOW(), NOW(), $jumlah, '$kode_unik')
              ON DUPLICATE KEY UPDATE nama_produk = VALUES(nama_produk), harga_produk = VALUES(harga_produk), jumlah = VALUES(jumlah), kode_unik = VALUES(kode_unik)";
...
<!-- Seluruh konten HTML tetap sama -->
