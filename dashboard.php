...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/resk.png">
...
<div class="sidebar">
        ...
        <div class="content">
    <h1 style="text-align: center; font-weight: bold;">Selamat Datang Di RESK SHOES WEB !</h1>
    <div style="text-align: center;">
    <div style="margin-top: 15px;">
        <img src="assets/img/resk.png" alt="resk" style="width: 500px; height: auto; border-radius: 9px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.2);">
    </div>
</div>
